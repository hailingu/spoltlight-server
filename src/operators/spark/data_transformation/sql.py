...
class Sql(SparkOperator):
    ...
    def __init__(self):
        ...
        self.op_script_location = 'resources/spark_operators/data_iport/sql.py'
    ...
    def init_operator(self, op_json_param):
        ...
        self.sql = op_json_param['sql'] if 'sql' in op_json_param else None
    ...
    def run_script_mode(self):
        ...
        run_command = run_command + self.op_script_location + ' ' + self.op_input_ops[0].get_result(self.op_input_ops_index[0]) + ' ' + self.op_result[0] + ' ' + self.sql
